...
hideElementsById(["selTianYear","tiannetMonthHead"],false);
...
hideElementsById(["tiannetYearHead","selTianMonth","selTianHour","selTianMinute"],true);
} 
//单击月份span标签响应 
function spanMonthCEvent(){ 
hideElementsById(["selTianMonth","tiannetYearHead"],false);
if(m_bolShowHour) hideElementsById(new Array("tiannetHourHead"),false); 
if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false); 
hideElementsById(["tiannetMonthHead","selTianYear","selTianHour","selTianMinute"],true);
} 
//单击小时span标签响应 
function spanHourCEvent(){ 
hideElementsById(["tiannetYearHead","tiannetMonthHead"],false);
if(m_bolShowHour) hideElementsById(new Array("selTianHour"),false); 
if(m_bolShowMinute) hideElementsById(new Array("tiannetMinuteHead"),false); 
hideElementsById(["tiannetHourHead","selTianYear","selTianMonth","selTianMinute"],true);
} 
//单击分钟span标签响应 
...
hideElementsById(["tiannetMinuteHead","selTianYear","selTianMonth","selTianHour"],true);
} 
//根据标签id隐藏或显示标签 
...
hideElementsById(["tiannetHourHead","selTianHour","tiannetMinuteHead","selTianMinute"],true);
if( m_bolShowHour ){ 
//显示小时 
...
//隐藏下拉框，显示相对应的head 
hideElementsById(["selTianYear","selTianMonth","selTianHour","selTianMinute"],true);
hideElementsById(["tiannetYearHead","tiannetMonthHead","tiannetHourHead","tiannetMinuteHead"],false);
tiannetSetDay(tiannetYear,tiannetMonth); 
tiannetWriteHead(); 
showTime(); 

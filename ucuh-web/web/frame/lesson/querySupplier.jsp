...
<script type="text/javascript" src="../js/ajaxfileupload.js"></script>
        ...
        function quxiaoRZ(userId){
          ...
          $.post(
           "shenHeSupplier.action",
           {"userId":userId,"supplierState":4},
           function(data){
            if(data.ok==1){
...
<body>
	...
	<fieldset> 
		...
		<table class="tableStyle" transMode="true" footer="normal">
			...
			<tr>
			<s:iterator value="designer.wbs" id="wb">
				<td><input type="text" class="default" style="width: 50px;" name="qtxxvalue" value="${wb.value }" disabled="disabled"/>折</td>
			</s:iterator>	
			</tr>
